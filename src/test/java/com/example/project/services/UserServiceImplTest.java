...
//        //given
    ...
    //TODO dorobic testy dla Resource
    @Test
    ...
    //TODO pomyslec nad zmiana void na GroupRoom czy cos zeby dokladniej sprawdzic czy sie powiodlo
    @Test
    void getUserProfile() {
        //given
        UserProfileDTO userProfileDTO = getUserProfileDTOMock();
    ...
    void should_return_user_already_banned_exception() {
        ...
        //then
        assertTrue(exception.getMessage().contains("User is already banned"));
        verify(userRepository, times(1)).findById(bannedUserId);
